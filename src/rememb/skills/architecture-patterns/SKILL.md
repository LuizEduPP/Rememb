...
description: Implement backend architecture patterns such as Clean Architecture, Hexagonal Architecture, and Domain-Driven Design. Use when the user needs service boundaries, monolith refactoring, layered architecture design, or dependency-direction fixes.
---
