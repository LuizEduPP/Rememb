...
description: Automate browsers and analyze performance with executable Puppeteer CLI scripts. Use when the user needs screenshots, network inspection, form automation, web scraping, or JavaScript debugging in a browser context.
license: Apache-2.0
---
