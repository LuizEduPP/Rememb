---
name: deep-research
description: Conduct comprehensive, multi-source research using web search, documentation lookup, and critical analysis. Use when the user asks for deep research, thorough investigation, or broad evidence-based analysis of complex topics.
---
