---
name: markitdown
description: Convert files and office documents to Markdown, including PDFs, Office files, images with OCR, audio with transcription, HTML, archives, and structured data. Use when the user needs markdown extraction or document-to-markdown conversion.
...
- **MCP Server**: markitdown-mcp (for AI assistant desktop integration)
