...
description: Organize complex work with file-based planning artifacts such as task_plan.md, findings.md, and progress.md. Use when the user needs a multi-step task, project, or research effort broken down and tracked across many tool calls.
user-invocable: true
---
...
- **Templates** are in `<skill-root>/templates/`
