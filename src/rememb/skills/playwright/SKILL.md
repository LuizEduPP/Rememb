...
description: write, debug, and maintain Playwright end-to-end tests for web applications. Use when working with
  ...
  E2E tests, setting up authentication for tests, API mocking/interception, visual regression testing, or CI/CD integration for browser tests. Triggers: Playwright, E2E test,
