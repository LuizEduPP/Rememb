---
name: ppt-creator
description: Create professional slide decks from topics or source documents, including structured content, charts, speaker notes, and complete PPTX outputs. Use when the user needs presentations, pitches, slide decks, or keynote-style materials.
---
...
- This skill **complements** any host-provided slide export capability. Use this skill to produce high-quality structure and content, then optionally invoke the current environment's export mechanism to generate the final PPTX file.
