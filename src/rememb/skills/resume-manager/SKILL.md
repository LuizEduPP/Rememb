---
name: resume-manager
description: Manage resumes, professional profiles, career history, and tailored job-application documents. Use when the user needs resume creation, resume updates, portfolio tracking, or role-specific resume generation from structured career data.
---
