...
description: Design and review software architecture, scalability strategy, dependency boundaries, and technical decisions. Use when the user asks for system design, architecture reviews, database choices, microservice tradeoffs, or architecture diagrams.
---
