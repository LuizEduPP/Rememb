...
description: Calculate key financial ratios and metrics from financial statement data for investment analysis. Use when the user needs ratio analysis, company performance review, or valuation support from financial statements.
---
