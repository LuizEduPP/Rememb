---
name: canvas-design
description: Create original visual art and design-forward static outputs in .png or .pdf formats. Use when the user asks for a poster, artwork, visual design piece, or other polished static composition.
...
- **Leave creative space**: Remain specific about the aesthetic direction, but concise enough that the next AI has room to make interpretive choices also at a extremely high level of craftmanship.
...
- **ARTISTIC FREEDOM**: The next AI interprets the philosophy visually - provide creative room
