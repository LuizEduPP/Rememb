...
description: Build advanced financial models with DCF analysis, sensitivity testing, Monte Carlo simulation, and scenario planning. Use when the user needs investment modeling, valuation scenarios, or decision support from financial assumptions.
---
