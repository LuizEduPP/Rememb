...
description: Apply systematic debugging techniques, profiling tools, and root-cause analysis across codebases and stacks. Use when the user needs to investigate bugs, performance issues, or unexpected behavior.
---
