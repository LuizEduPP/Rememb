...
description: Manage advanced Git workflows including rebasing, cherry-picking, bisect, worktrees, and reflog recovery. Use when the user needs clean history management, complex collaboration flows, or repository recovery.
---
