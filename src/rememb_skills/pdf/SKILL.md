---
name: pdf
description: Read, extract, merge, split, rotate, watermark, create, fill, encrypt, decrypt, and OCR PDF files. Use when the user mentions PDFs or needs any document workflow centered on .pdf files.
