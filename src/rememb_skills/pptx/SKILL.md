---
name: pptx
description: Create, read, edit, split, combine, and extract content from .pptx presentation files. Use when the user mentions slides, decks, presentations, or any workflow where a PowerPoint file is the primary artifact.
