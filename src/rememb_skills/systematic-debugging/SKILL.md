...
description: Diagnose bugs, test failures, and unexpected behavior before proposing fixes. Use when the user reports a defect and root cause needs to be established before editing code.
---
